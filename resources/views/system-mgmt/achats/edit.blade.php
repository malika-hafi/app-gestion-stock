        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('achats.update', ['id' => $achats->id]) }}">
...
<select  id="statut"   class="form-control" name="statut" value=" {{ $achats->statut }}" required autofocus>
