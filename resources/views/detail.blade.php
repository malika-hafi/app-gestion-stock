  ...
  <div class="container">
    ...
    <section class="invoice">
      ...
      <div class="col-md-12">
        <a href="{{route('country.index')}}" class="btn btn-sm btn-success">Back</a>
      </div>
          <button type="button" class="btn btn-success pull-right"><i class="fa fa-credit-card"></i>  
          </button>
         <a href="{{ route('report.pdf') }}"> <button type="button" class="btn btn-primary pull-right" style="margin-right: 5px;">
